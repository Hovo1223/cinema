...
<body>
    <allparent>
        <header>
                ...
                <nav class="ulLiParent d-flex justify-content-end w-100">
                    <div class="our">
                        ...
                        <li class="{{ request()->is('home/about') ? 'active' : '' }}">
                            <a href="{{ url('home/about') }}">Մեր մասին</a>
                        </li>
                            <li>Ընթացիկ</li>
                            <li>Սպասվող</li>
                            <li>Պրոմո</li>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    @foreach($selectedFilmIds as $key => $selectedFilmIds)
                    <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="{{ $key }}"
                        @if($key==0) class="active" aria-current="true" @endif
                        aria-label="Սլայդ {{ $key + 1 }}">
                    </button>
                    @endforeach
                </div>
                ...
                @foreach($selectedFilms as $key => $selectedFilm)
                <a href="{{ route('home.view', ['id' => $selectedFilm->id]) }}">
                    <div class="carousel-item @if($key == 0) active @endif">
                        <img src="{{ asset($selectedFilm->image) }}" class="d-block w-100">
                    </div>
                </a>
                @endforeach
            ...
            @if($ActiveFilmsChecked == 0)

            <div class="movesActivParent">
                <div class="container movesNameContainer">
                    <h2 class='movesName'>Ընթացիկ ֆիլմեր</h2>
                </div>
            </div>
                ...
                <div class="slide-content">
                    ...
                    <div class="card-wrapper swiper-wrapper">
                        ...
                        <div class="card swiper-slide movesSwiper">
                            <a href="{{ route('home.view', ['id' => $slide_now->id]) }}">
                            <div class="image-content">
                                <span class="overlay"></span>
                                <img src="{{ $slide_now->post_image }}" class="movePhotosSlides" style='border-radius:25px' alt="">
        ...
        <main>
            ...
            <div class="moveList">
                <div class="container moveListContainer">
                    <h2 style="color:white; padding-bottom:54px; font-size: 29px; padding-left:100px">Ֆիլմացանկ</h2>
            ...
            @if($promoOnOf == 0)
            <div class="promo">
                <div class="container containerPromo" style="max-width:90%; padding-left:0;">
                    <h2 class="promoWord">Պրոմո</h2>
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper promoSwiper">
                            @foreach($promos as $promo)
                            <div class="swiper-slide secondSwiperSlide" style="border-radius: 25px;">
                                <img src="{{ asset('storage/' . $promo->image) }}" alt="Նկար">
                                <div class="hoverdesc">
                                    <div class="descCardParent">
                                        <div class="Card">
                                            <h5>{{$promo->subtitle}}</h5>
                                        </div>
                                        <p>{{$promo->title}}</p>
                                    </div>
                                    <div class="readerMoreparent">
                                        <p>Կարդալ ավելին</p>
                                        <span>≫</span>
                                    </div>
                                </div>
            ...
            @if($follow ==0)
                <div class="follow">
                    <div class="followImage" style='position:relative; width:100%'>
                        <img class="earthPicture" src="images/earth.webp" alt="">
                        <div class="followInputPArent" style='position:absolute'>
                            <form class='followForm' action="">
                                <div class='emailInputClass' style="display: flex; justify-content: center; align-items: center; flex-direction: column; text-align: center;">
                                    <div class="followTitle">
                                        <span>Բ</span>
                                        <img class='subWord' src="images/subscribe-letter.png" alt="">
                                        <span>ժ</span>
                                        <img class='subWord' src="images/subscribe-letter.png" alt="">
                                        <span>Ն</span>
                                        <span>Ո</span>
                                    ...
                                    <p style="margin-top: 40px;margin-bottom:40px; color: white; font-size: 18px; font-family: font-family: 'Arian AMU Bold', sans-serif;">
                                        Բաժանորդագրվի՛ր և առաջինը տեղեկացի՛ր կինոպրեմիերաների մասին:
                                    </p>

                                    <div class="subscribeDescription" style="display: flex; justify-content: center; align-items: center; margin-top: 20px;">
                                        <input type="email" name="email" id="email" aria-label="Էլ.հասցե" placeholder="Էլ.հասցե" class="emailInput" style="border-radius: 25px; padding: 10px 20px; border: none; outline: none; width: 370px;height: 58px; max-width: 80%; font-size: 16px;" />
            ...
            @if($UpcomingMovies == 0)
                <div class="UpcomingMovies">
                    <div class="UpcomingMovesTitle">
                        <h2>Սպասվող ֆիլմեր</h2>
                    </div>
                    <div class="swiper tu1">
                        <div class="swiper-wrapper upcomingSwiper">
                            @foreach($slides_after as $slide_after)
                            <a href="{{ route('home.view', ['id' => $slide_after->id]) }}">
                            <div class="swiper-slide hover-effect">
                                <img src="{{ $slide_after->post_image }}" alt="">
                                <div class="descriptionUpcomingMoves">
                                    <h5>{{ $slide_after->title }}</h5>
                                    <div class="info-line" style="padding-top:10px; font-size:14px; text-align:start; margin:0;">
                                        <span>{{ $slide_after->age }}+</span>
                                        <span class="separator"></span>
                                        <div class="genre-text" style='height: 100%;display: flex;flex-direction: column; gap: 0;'>
                                            <span>
                                                @foreach($slide_after->genres as $genre)
                                                {{ $genre->genre }},
                                                @endforeach
                                            </span>
                                        </div>
                                    </div>
                                    <button class="buttonTrailer">
                        ...
                        <div class="swiper-button-next upcomingSwipeNext"></div>
                        <div class="swiper-button-prev upcomingSwipePrev"></div>
                    </div>
                </div>
                @endif
        </main>
    ...
    <script>
        ...
        var swiper1 = new Swiper(".slide-content", {
            ...
            grabCursor: true,
            navigation: {
                nextEl: ".nextSwipeFirst",
                prevEl: ".prevSwipeFirst",
            },
            slidesPerView: 6,
            slidesToScroll: 1,
            rewind: true,
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const slides = document.querySelectorAll('.mySwiper .secondSwiperSlide');
        ...
        const myswiper1 = new Swiper('.tu1', {
            loop: true,
            navigation: {
                nextEl: '.tu1 .swiper-button-next',
                prevEl: '.tu1 .swiper-button-prev',
            },
            slidesPerView: 6,
            spaceBetween: 20,
            rewind: true,
